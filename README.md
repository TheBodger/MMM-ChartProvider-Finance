...
| `value`            |*Required* - The key name, including any parent levels up to but excluding the rootkey level that will be used to populate the value field value.<br><br> **Possible values:** Any string of a dot notation JSON key address. <br> **Default value:** the field name in the object field will be used to obtain a value
